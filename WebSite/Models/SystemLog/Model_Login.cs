...
namespace Website.Models.SystemLog
{
    public class Model_Login
    {
        public Model_Login()
        {
            ...
            this.LogList = new List<Service_sysLogin_log.VW_sysLogin_log>();
            IniSet();
        }
        ...
        /// 資料列
        /// </summary>
        public List<Service_sysLogin_log.VW_sysLogin_log> LogList { get; set; }
        ...
        public BaseResult Load()
        {
            try
            {
                ...
                {
                    //this.qrybeg = this.qrybeg ?? DateTime.Now.AddMinutes(-60);
                ...
                this.LogList = Service_sysLogin_log.GetVWList(this.LoginID, this.qrybeg, this.qryend, this.page);
            }
            catch (Exception e)
            {
